...
async function fetchFloodRiskData(request: any, logger: Logger): Promise<FloodRiskData> {
  ...
  try {
    ...
    const [surfaceWaterData, riversSeaData, groundwaterData, reservoirsData, warningsData] = await Promise.all([
 ...
 */
async function fetchSurfaceWaterRisk(params: Record<string, string>, apiClient: ExternalApiClient, logger: Logger) {
  try {
 ...
 */
async function fetchRiversAndSeaRisk(params: Record<string, string>, apiClient: ExternalApiClient, logger: Logger) {
  try {
    const response = await apiClient.get('/flood-monitoring/id/floodAreas', params);
 ...
 */
async function fetchGroundwaterRisk(params: Record<string, string>, apiClient: ExternalApiClient, logger: Logger) {
  try {
    const response = await apiClient.get('/flood-monitoring/id/floodAreas', params);
 ...
 */
async function fetchReservoirsRisk(params: Record<string, string>, apiClient: ExternalApiClient, logger: Logger) {
  try {
    const response = await apiClient.get('/flood-monitoring/id/floodAreas', params);
 ...
 */
async function fetchFloodWarnings(params: Record<string, string>, apiClient: ExternalApiClient, logger: Logger) {
  try {
    const response = await apiClient.get('/flood-monitoring/id/floodAreas', params);
...
function calculateOverallRiskLevel(levels: string[]): 'Very Low' | 'Low' | 'Medium' | 'High' | 'Very High' {
