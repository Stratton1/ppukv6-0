  ...
  const checks = [
    {
      ...
      completed: !!(property.address_line_1 && property.postcode),
    },
    {
      id: "type",
      label: "Property type & style",
      completed: !!(property.property_type && property.property_style),
    },
    {
      id: "bedrooms",
    ...
    { id: "frontPhoto", label: "Front elevation photo", completed: !!property.front_photo_url },
    {
      ...
      completed: documents.some(d => d.document_type === "epc"),
    },
    {
      id: "floorplan",
      label: "Floorplan",
      completed: documents.some(d => d.document_type === "floorplan"),
    },
    {
      id: "titleDeed",
      label: "Title deed",
      completed: documents.some(d => d.document_type === "title_deed"),
    },
