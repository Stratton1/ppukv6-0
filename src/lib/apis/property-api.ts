...
import type { EPCData, HMLRData, FloodRiskData, PropertyIdentifier } from "../../types/api";
...
// Request types
type EPCRequest = PropertyIdentifier;
interface HMLRRequest extends PropertyIdentifier {
  titleNumber?: string;
}
type FloodRiskRequest = PropertyIdentifier;
...
export const getFloodRiskData = (request: FloodRiskRequest) =>
  propertyApi.getFloodRiskData(request);
export const getAllPropertyData = (property: PropertyIdentifier) =>
  propertyApi.getAllPropertyData(property);
